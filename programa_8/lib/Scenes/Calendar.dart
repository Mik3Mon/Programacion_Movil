...
class _CalendarPageState extends State<CalendarPage>{
  ...
  void changeColor(Color color) => setState(() => dateColor = color);

  void addMeeting(context){
    dateColor = Color.fromRGBO(0, 0, 0, 1);
    textStartTime.text = "";
    textEndTime.text = "";
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius: MediaQuery.of(context).orientation == Orientation?
                                        const BorderRadius.vertical(top: Radius.circular(500), bottom: Radius.circular(100))
                                          : const BorderRadius.horizontal(right: Radius.circular(0), left: Radius.circular(0))
                                  ),
